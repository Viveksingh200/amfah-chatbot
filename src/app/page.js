                  ...
                  <div className={styles.contactBanner}>
                    ...
                    <div className={styles.contactButtons}>
                      ...
                      <button 
                        ...
                        onClick={() => {
                          const userEmailPrompt = prompt('Please enter your Email Address to receive custom product information:');
                          if (userEmailPrompt && userEmailPrompt.includes('@')) {
                            sendMessage(`Please send email inquiry for my email: ${userEmailPrompt}`);
                          }
                        }}
                      >
                        <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
